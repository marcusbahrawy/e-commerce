...
?>
<p><a href="<?= url('/admin/ordrer') ?>">← Tilbake til ordreliste</a></p>

<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-bottom: 1.5rem;">
    <div>
        <h2 style="margin-top: 0;">Ordre <?= e($order['public_id'] ?? '') ?></h2>
    ...
    <div>
        <h3 style="margin-top: 0;">Oppdater status</h3>
        <form method="post" action="<?= url('/admin/ordrer/' . e($order['public_id'] ?? '') . '/status') ?>" style="display: flex; flex-wrap: wrap; gap: 0.5rem; align-items: flex-end;">
            <?= csrf_field() ?>
            <label>Ordrestatus
            ...
            <label>Levering
                <select name="fulfillment_status" class="input">
                    <option value="">— ikke endre —</option>
...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-bottom: 1.5rem;">
    ...
    <div>
        <h3 style="margin-top: 0;">Leveringsadresse</h3>
    ...
    <div>
        <h3 style="margin-top: 0;">Fakturaadresse</h3>
